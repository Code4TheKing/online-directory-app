...
import { ADD_CONTACT_PATH, EDIT_CONTACT_PATH, HOME_PATH, PROFILE_PATH, SEARCH_PATH } from '../OnlineDirectoryApp';
        ...
        <Nav className="w-100">
          ...
          {isAuthenticated && <Nav.Item className="align-self-center">
            <LinkContainer to="/search">
              <Nav.Link active={location.pathname === SEARCH_PATH}>Search</Nav.Link>
            </LinkContainer>
          </Nav.Item>}
